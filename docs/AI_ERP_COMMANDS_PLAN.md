...
| next | Phase 2's ten commands are done. Phase 3 — or hardening what exists: the class-channel ERP-write gap noted above, and an end-to-end run on real data with the director. |
