...
| next | Phase 1 read commands: a student's pending fees, today's attendance summary, class defaulters, today's collection, free teachers in a period, pending leaves, homework posted, bus manifest, student details, school snapshot, admissions this week. |
