...
> = {
  ...
  gold: {
    icon: "bg-[rgba(197,160,40,0.18)] text-[var(--tone-amber)]",
    chip: "bg-[rgba(197,160,40,0.14)] text-[var(--tone-amber)]",
  ...
  sky: {
    icon: "bg-[rgba(2,132,199,0.12)] text-[var(--tone-sky)]",
    chip: "bg-[rgba(2,132,199,0.1)] text-[var(--tone-sky)]",
    bar: "bg-[#0284c7]",
  ...
  slate: {
    icon: "bg-[rgba(71,85,105,0.12)] text-[var(--tone-slate)]",
    chip: "bg-[rgba(71,85,105,0.1)] text-[var(--tone-slate)]",
    bar: "bg-[#475569]",
  ...
  },
  {
    ...
    hubs: [
      ...
      },
      {
        ...
        blurb: "Visit log",
        detail: "Nurse visits, medication & vaccination records, emergency contacts.",
        icon: HeartPulse,
        tone: "rose",
      },
      {
        href: "/visitors",
        title: "Visitor / gate",
        blurb: "Front-gate register",
        detail: "Visitor check-in/out with QR pass, and early-pickup gate passes.",
        icon: DoorOpen,
        tone: "teal",
      },
    ],
