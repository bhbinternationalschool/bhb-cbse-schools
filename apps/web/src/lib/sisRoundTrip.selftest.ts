...
const student: SisStudent = normalizeStudent({
  ...
  apaarConsent: "given",
  apaarConsentAt: "2026-09-21T13:00:00.000Z",
  apaarConsentBy: "SUJEET SINGH · WhatsApp +918303976426",
  apaarConsentFileId: "1AbCdEfGhIjKlMnOp",
...
const STUDENT_FIELDS: Record<keyof Required<SisStudent>, true> = {
  ...
  udiseComplianceRemindedAt: true, udiseAadhaarValidationStatus: true, apaarConsent: true, apaarConsentAt: true, apaarConsentBy: true, apaarConsentFileId: true,
