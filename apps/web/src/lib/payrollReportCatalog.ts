  ...
  switch (id) {
    ...
    case "structure_assignment": {
      ...
      columns = [
        ...
        { key: "additional", header: "Additional (outside PF/ESIC)", align: "right" },
        { key: "grossUp", header: "School bears PF/ESIC" },
      ...
      rows = (masters.staff ?? [])
        ...
        .map((s) => {
          ...
          return {
            ...
            additional: money(link?.additionalAmount || 0),
            grossUp: link?.statutoryGrossUp ? "yes" : "no",
